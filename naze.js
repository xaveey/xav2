...
//PEMBATAS=======================================
          ...
          m.reply(`Exif berhasil diubah menjadi\n\n⌗ ࣪ ▸ Packname : ${global.packname}\n⌗ ࣪ ▸ Author : ${global.author}`)
            }
            break
	case 'kick': {
		if (!m.isGroup) throw mess.group
	...
	case 'menfes': case 'menfess': {
	    ...
	    case 'yts': case 'ytsearch': {
                ...
                for (let i of search.all) {
                    teks += `⌗ ࣪ ▸ No : ${no++}\n⌗ ࣪ ▸ Type : ${i.type}\n⌗ ࣪ ▸ Video ID : ${i.videoId}\n⌗ ࣪ ▸ Title : ${i.title}\n⌗ ࣪ ▸ Views : ${i.views}\n⌗ ࣪ ▸ Duration : ${i.timestamp}\n⌗ ࣪ ▸ Upload At : ${i.ago}\n⌗ ࣪ ▸ Author : ${i.author.name}\n⌗ ࣪ ▸ Url : ${i.url}\n\n─────────────────\n\n`
                }
        ...
        case 'google': {
                ...
                for (let g of res) {
                teks += `⌗ ࣪ ▸ *Title* : ${g.title}\n`
                teks += `⌗ ࣪ ▸ *Description* : ${g.snippet}\n`
                teks += `⌗ ࣪ ▸ *Link* : ${g.link}\n\n────────────────────────\n\n`
                } 
                m.reply(teks)
                })
...
⌗ ࣪ ▸ Ext : Search
⌗ ࣪ ▸ ID : ${anu.videoId}
⌗ ࣪ ▸ Duration : ${anu.timestamp}
⌗ ࣪ ▸ Viewers : ${anu.views}
⌗ ࣪ ▸ Upload At : ${anu.ago}
⌗ ࣪ ▸ Author : ${anu.author.name}
⌗ ࣪ ▸ Channel : ${anu.author.url}
⌗ ࣪ ▸ Description : ${anu.description}
⌗ ࣪ ▸ Url : ${anu.url}`,
                    footer: naze.user.name,
                    buttons: buttons,
                    headerType: 4
	    ...
	    case 'ytmp3': case 'ytaudio': {
                ...
                naze.sendImage(m.chat, media.thumb, `⌗ ࣪ ▸ Title : ${media.title}\n⌗ ࣪ ▸ File Size : ${media.filesizeF}\n⌗ ࣪ ▸ Url : ${isUrl(text)}\n⌗ ࣪ ▸ Ext : MP3\n⌗ ࣪ ▸ Resolusi : ${args[1] || '128kbps'}`, m)
            ...
            case 'ytmp4': case 'ytvideo': {
                ...
                if (media.filesize >= 100000) return m.reply('File Melebihi Batas '+util.format(media))
                naze.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `⌗ ࣪ ▸ Title : ${media.title}\n⌗ ࣪ ▸ File Size : ${media.filesizeF}\n⌗ ࣪ ▸ Url : ${isUrl(text)}\n⌗ ࣪ ▸ Ext : MP3\n⌗ ࣪ ▸ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
	    case 'getmusic': {
                let { yta } = require('./lib/y2mate')
		...
		let { pinterest } = require('./lib/scraper')
                ...
                naze.sendMessage(m.chat, { image: { url: result }, caption: '⌗ ࣪ ▸ Media Url : '+result }, { quoted: m })
            }
            break
            case 'waifu': {
            	m.reply(mess.wait)
		...
		let buttons = [
                ...
                let buttonMessage = {
                    ...
                    caption: `⌗ ࣪ ▸ Title : ${result.title}\n⌗ ࣪ ▸ Category : ${result.type}\n⌗ ࣪ ▸ Detail : ${result.source}\n⌗ ࣪ ▸ Media Url : ${result.image[2] || result.image[1] || result.image[0]}`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
		...
		let { wikimedia } = require('./lib/scraper')
                ...
                let buttonMessage = {
                    ...
                    caption: `⌗ ࣪ ▸ Title : ${result.title}\n⌗ ࣪ ▸ Source : ${result.source}\n⌗ ࣪ ▸ Media Url : ${result.image}`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
...
//Pembatas========================================
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artimimpi': case 'tafsirmimpi': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Mimpi :* ${anu.message.mimpi}\n⌗ ࣪ ▸ *Arti :* ${anu.message.arti}\n⌗ ࣪ ▸ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
            case 'ramalanjodoh': case 'ramaljodoh': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Nama Anda :* ${anu.message.nama_anda.nama}\n⌗ ࣪ ▸ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⌗ ࣪ ▸ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⌗ ࣪ ▸ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⌗ ࣪ ▸ *Hasil :* ${anu.message.result}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'suamiistri': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Nama Suami :* ${anu.message.suami.nama}\n⌗ ࣪ ▸ *Lahir Suami :* ${anu.message.suami.tgl_lahir}\n⌗ ࣪ ▸ *Nama Istri :* ${anu.message.istri.nama}\n⌗ ࣪ ▸ *Lahir Istri :* ${anu.message.istri.tgl_lahir}\n⌗ ࣪ ▸ *Hasil :* ${anu.message.result}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalancinta': case 'ramalcinta': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Nama Anda :* ${anu.message.nama_anda.nama}\n⌗ ࣪ ▸ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⌗ ࣪ ▸ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⌗ ࣪ ▸ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⌗ ࣪ ▸ *Sisi Positif :* ${anu.message.sisi_positif}\n⌗ ࣪ ▸ *Sisi Negatif :* ${anu.message.sisi_negatif}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'artinama': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Nama :* ${anu.message.nama}\n⌗ ࣪ ▸ *Arti :* ${anu.message.arti}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'kecocokannama': case 'cocoknama': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Nama :* ${anu.message.nama}\n⌗ ࣪ ▸ *Lahir :* ${anu.message.tgl_lahir}\n⌗ ࣪ ▸ *Life Path :* ${anu.message.life_path}\n⌗ ࣪ ▸ *Destiny :* ${anu.message.destiny}\n⌗ ࣪ ▸ *Destiny Desire :* ${anu.message.destiny_desire}\n⌗ ࣪ ▸ *Personality :* ${anu.message.personality}\n⌗ ࣪ ▸ *Persentase :* ${anu.message.persentase_kecocokan}`, m)
            }
            break
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendImage(m.chat,  anu.message.gambar, `⌗ ࣪ ▸ *Nama Anda :* ${anu.message.nama_anda}\n⌗ ࣪ ▸ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⌗ ࣪ ▸ *Sisi Positif :* ${anu.message.sisi_positif}\n⌗ ࣪ ▸ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Tanggal Pernikahan :* ${anu.message.tanggal}\n⌗ ࣪ ▸ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Lahir :* ${anu.message.hari_lahir}\n⌗ ࣪ ▸ *Usaha :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'pekerjaan': case 'kerja': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Lahir :* ${anu.message.hari_lahir}\n⌗ ࣪ ▸ *Pekerjaan :* ${anu.message.pekerjaan}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalannasib': case 'ramalnasib': case 'nasib': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Analisa :* ${anu.message.analisa}\n⌗ ࣪ ▸ *Angka Akar :* ${anu.message.angka_akar}\n⌗ ࣪ ▸ *Sifat :* ${anu.message.sifat}\n⌗ ࣪ ▸ *Elemen :* ${anu.message.elemen}\n⌗ ࣪ ▸ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendImage(m.chat, anu.message.image, `⌗ ࣪ ▸ *Lahir :* ${anu.message.tgl_lahir}\n⌗ ࣪ ▸ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⌗ ࣪ ▸ *Arti :* ${anu.message.arti}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Nama :* ${anu.message.nama}\n⌗ ࣪ ▸ *Lahir :* ${anu.message.tahun_lahir}\n⌗ ࣪ ▸ *Gender :* ${anu.message.jenis_kelamin}\n⌗ ࣪ ▸ *Angka Kua :* ${anu.message.angka_kua}\n⌗ ࣪ ▸ *Kelompok :* ${anu.message.kelompok}\n⌗ ࣪ ▸ *Karakter :* ${anu.message.karakter}\n⌗ ࣪ ▸ *Sektor Baik :* ${anu.message.sektor_baik}\n⌗ ࣪ ▸ *Sektor Buruk :* ${anu.message.sektor_buruk}`, m)
            }
            break
            case 'haribaik': {
                if (!text) throw `Example : ${prefix + command} 7,7,2005`
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Lahir :* ${anu.message.tgl_lahir}\n⌗ ࣪ ▸ *Kala Tinantang :* ${anu.message.kala_tinantang}\n⌗ ࣪ ▸ *Info :* ${anu.message.info}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'harinaas': case 'harisial': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Hari Lahir :* ${anu.message.hari_lahir}\n⌗ ࣪ ▸ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⌗ ࣪ ▸ *Hari Naas :* ${anu.message.hari_naas}\n⌗ ࣪ ▸ *Info :* ${anu.message.catatan}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.info}`, m)
            }
            break
            case 'nagahari': case 'harinaga': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Hari Lahir :* ${anu.message.hari_lahir}\n⌗ ࣪ ▸ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⌗ ࣪ ▸ *Arah Naga Hari :* ${anu.message.arah_naga_hari}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'arahrejeki': case 'arahrezeki': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Hari Lahir :* ${anu.message.hari_lahir}\n⌗ ࣪ ▸ *tanggal Lahir :* ${anu.message.tgl_lahir}\n⌗ ࣪ ▸ *Arah Rezeki :* ${anu.message.arah_rejeki}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'peruntungan': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Nama :* ${anu.message.nama}\n⌗ ࣪ ▸ *Lahir :* ${anu.message.tgl_lahir}\n⌗ ࣪ ▸ *Peruntungan Tahun :* ${anu.message.peruntungan_tahun}\n⌗ ࣪ ▸ *Hasil :* ${anu.message.result}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'weton': case 'wetonjawa': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Tanggal :* ${anu.message.tanggal}\n⌗ ࣪ ▸ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⌗ ࣪ ▸ *Watak Hari :* ${anu.message.watak_hari}\n⌗ ࣪ ▸ *Naga Hari :* ${anu.message.naga_hari}\n⌗ ࣪ ▸ *Jam Baik :* ${anu.message.jam_baik}\n⌗ ࣪ ▸ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            case 'sifat': case 'karakter': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Nama :* ${anu.message.nama}\n⌗ ࣪ ▸ *Lahir :* ${anu.message.tgl_lahir}\n⌗ ࣪ ▸ *Garis Hidup :* ${anu.message.garis_hidup}`, m)
            }
            break
            case 'keberuntungan': {
                if (!text) throw `Example : ${prefix + command} Dika, 7,7,2005`
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Hasil :* ${anu.message.result}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
            ...
            case 'zodiak': case 'zodiac': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                naze.sendText(m.chat, `⌗ ࣪ ▸ *Zodiak :* ${anu.message.zodiak}\n⌗ ࣪ ▸ *Nomor :* ${anu.message.nomor_keberuntungan}\n⌗ ࣪ ▸ *Aroma :* ${anu.message.aroma_keberuntungan}\n⌗ ࣪ ▸ *Planet :* ${anu.message.planet_yang_mengitari}\n⌗ ࣪ ▸ *Bunga :* ${anu.message.bunga_keberuntungan}\n⌗ ࣪ ▸ *Warna :* ${anu.message.warna_keberuntungan}\n⌗ ࣪ ▸ *Batu :* ${anu.message.batu_keberuntungan}\n⌗ ࣪ ▸ *Elemen :* ${anu.message.elemen_keberuntungan}\n⌗ ࣪ ▸ *Pasangan Zodiak :* ${anu.message.pasangan_zodiak}\n⌗ ࣪ ▸ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
...
//PEMBATAS=======================================
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    if (anu.status == false) return m.reply(anu.result.message)
                    naze.sendMedia(m.chat, anu.caption.profile_hd, '', `⌗ ࣪ ▸ Full Name : ${anu.caption.full_name}\n⌗ ࣪ ▸ User Name : ${anu.caption.user_name}\n⌗ ࣪ ▸ ID ${anu.caption.user_id}\n⌗ ࣪ ▸ Followers : ${anu.caption.followers}\n⌗ ࣪ ▸ Following : ${anu.caption.following}\n⌗ ࣪ ▸ Bussines : ${anu.caption.bussines}\n⌗ ࣪ ▸ Profesional : ${anu.caption.profesional}\n⌗ ࣪ ▸ Verified : ${anu.caption.verified}\n⌗ ࣪ ▸ Private : ${anu.caption.private}\n⌗ ࣪ ▸ Bio : ${anu.caption.biography}\n⌗ ࣪ ▸ Bio Url : ${anu.caption.bio_url}`, m)
		    db.data.users[m.sender].limit -= 1
                } else if (type.toLowerCase() == 'npm') {
                    if (!id) throw `No Query username, Example : ${prefix + command} npm scrape-primbon`
                    let { result: anu } = await fetchJson(api('zenz', '/api/stalker/npm', { query: id }, 'apikey'))
                    if (anu.status == false) return m.reply(anu.result.message)
                    m.reply(`⌗ ࣪ ▸ Name : ${anu.name}\n⌗ ࣪ ▸ Version : ${Object.keys(anu.versions)}\n⌗ ࣪ ▸ Created : ${tanggal(anu.time.created)}\n⌗ ࣪ ▸ Modified : ${tanggal(anu.time.modified)}\n⌗ ࣪ ▸ Maintainers :\n ${anu.maintainers.map(v => `- ${v.name} : ${v.email}`).join('\n')}\n\n⌗ ࣪ ▸ Description : ${anu.description}\n⌗ ࣪ ▸ Homepage : ${anu.homepage}\n⌗ ࣪ ▸ Keywords : ${anu.keywords}\n⌗ ࣪ ▸ Author : ${anu.author.name}\n⌗ ࣪ ▸ License : ${anu.license}\n⌗ ࣪ ▸ Readme : ${anu.readme}`)
		    db.data.users[m.sender].limit -= 1
                } else {
           ...
           /**case 'tiktokwm': case 'tiktokwatermark': {
            ...
            case 'joox': case 'jooxdl': {
                ...
                let msg = await naze.sendImage(m.chat, anu.result.img, `⌗ ࣪ ▸ Title : ${anu.result.lagu}\n⌗ ࣪ ▸ Album : ${anu.result.album}\n⌗ ࣪ ▸ Singer : ${anu.result.penyanyi}\n⌗ ࣪ ▸ Publish : ${anu.result.publish}\n⌗ ࣪ ▸ Lirik :\n${anu.result.lirik.result}`, m)
            ...
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await naze.sendImage(m.chat, anu.result.thumb, `⌗ ࣪ ▸ Title : ${anu.result.title}\n⌗ ࣪ ▸ Url : ${isUrl(text)[0]}`)
	        ...
	        case 'fbdl': case 'fb': case 'facebook': {
                ...
                naze.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `⌗ ࣪ ▸ Title : ${anu.result.title}`}, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        naze.sendMessage(m.chat, { image: { url }, caption: `⌗ ࣪ ▸ Title : ${anu.title}\n⌗ ࣪ ▸ Author : ${anu.author.name}\n⌗ ࣪ ▸ Like : ${anu.like}\n⌗ ࣪ ▸ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		...
		case 'playstore': {
            ...
            let teks = `⌗ ࣪ ▸ Playstore Search From : ${text}\n\n`
            for (let i of res.result) {
            teks += `⌗ ࣪ ▸ Name : ${i.name}\n`
            teks += `⌗ ࣪ ▸ Link : ${i.link}\n`
            teks += `⌗ ࣪ ▸ Developer : ${i.developer}\n`
            teks += `⌗ ࣪ ▸ Link Developer : ${i.link_dev}\n\n──────────────────────\n`
            }
            m.reply(teks)
            }
            break
...
⌗ ࣪ ▸ Inchi: ${inchi}
⌗ ࣪ ▸ Pixel: ${pixel}
⌗ ࣪ ▸ Video Pixel: ${videoPixel}
⌗ ࣪ ▸ Ram: ${ram}
⌗ ࣪ ▸ Chipset: ${chipset}
⌗ ࣪ ▸ Battery: ${batrai}
⌗ ࣪ ▸ Battery Brand: ${merek_batre}
⌗ ࣪ ▸ Detail: ${detail}`
            ...
            for (let i of res.result){
            capt += `⌗ ࣪ ▸ Title: ${i.title}\n`
            capt += `⌗ ࣪ ▸ Thumbnail: ${i.thumb}\n`
            capt += `⌗ ࣪ ▸ Url: ${i.url}\n\n──────────────────────\n`
            }
            ...
            for (let i of res.result){
            capt += `⌗ ࣪ ▸ Community: ${i.community}\n`
            capt += `⌗ ࣪ ▸ Community Link: ${i.community_link}\n`
            capt += `⌗ ࣪ ▸ Thumbnail: ${i.community_thumb}\n`
            capt += `⌗ ࣪ ▸ Description: ${i.community_desc}\n`
            capt += `⌗ ࣪ ▸ Member Count: ${i.member_count}\n\n──────────────────────\n`
            }
            ...
            capt += `⌗ ࣪ ▸ Judul: ${judul}\n`
            capt += `⌗ ࣪ ▸ Dibaca: ${dibaca}\n`
            capt += `⌗ ࣪ ▸ Divote: ${divote}\n`
            capt += `⌗ ࣪ ▸ Bab: ${bab}\n`
            capt += `⌗ ࣪ ▸ Waktu: ${waktu}\n`
            capt += `⌗ ࣪ ▸ Url: ${url}\n`
            capt += `⌗ ࣪ ▸ Deskripsi: ${description}`
            naze.sendImage(m.chat, thumb, capt, m)
            }
            break
            case 'webtoons': {
            ...
            for (let i of res.result) {
            capt += `⌗ ࣪ ▸ Judul: ${i.judul}\n`
            capt += `⌗ ࣪ ▸ Like: ${i.like}\n`
            capt += `⌗ ࣪ ▸ Creator: ${i.creator}\n`
            capt += `⌗ ࣪ ▸ Genre: ${i.genre}\n`
            capt += `⌗ ࣪ ▸ Url: ${i.url}\n\n──────────────────────\n`
            }
            m.reply(capt)
            }
            ...
            for (let i of res.result) {
            capt += `⌗ ࣪ ▸ Judul: ${i.judul}\n`
            capt += `⌗ ࣪ ▸ Years: ${i.years}\n`
            capt += `⌗ ࣪ ▸ Genre: ${i.genre}\n`
            capt += `⌗ ࣪ ▸ Url: ${i.url}\n`
            capt += `⌗ ࣪ ▸ Thumbnail Url: ${i.thumbnail}\n\n──────────────────────\n`
            }
...
▸「 𝐈𝐍𝐅𝐎 𝐔𝐒𝐄𝐑 」
⌗ ࣪ ▸ ࣪ *Nama* : ${pushname}
⌗ ࣪ ▸ ࣪ *Number* : @${me.split('@')[0]}
⌗ ࣪ ▸ ࣪ *Premium* : ${isPremium ? '✅' : `❌`}
⌗ ࣪ ▸ ࣪ *Limit* : ${isPremium ? '♾Infinity' : `〽️${db.data.users[m.sender].limit}`}


  ▸「 𝐈𝐍𝐅𝐎 𝐁𝐎𝐓 」
⌗ ࣪ ▸ ࣪ *Nama Bot* : 𝗫𝗮𝘃𝗲𝗲 𝗕𝗼𝘁𝘇
⌗ ࣪ ▸ ࣪ *Powered* : @${ini_mark.split('@')[0]}
⌗ ࣪ ▸ ࣪ *Owner* : @${ownernya.split('@')[0]}
⌗ ࣪ ▸ ࣪ *Mode* : ${naze.public ? 'Public' : `Self`}
⌗ ࣪ ▸ ࣪ *Prefix* :「 MULTI-PREFIX 」

 ▸ 「 𝐈𝐍𝐅𝐎 𝐎𝐖𝐍𝐄𝐑  」
⌗ ࣪ ▸ ࣪ *Nama* : Xaveyaa
⌗ ࣪ ▸ ࣪ *Umur* : 15
⌗ ࣪ ▸ ࣪ *Ultah* : 15 juli
⌗ ࣪ ▸ ࣪ *Asal* : Lamteng - Palembang 

 ▸ 「 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 𝐓𝐈𝐌𝐄  」
⌗ ࣪ ▸ ࣪ *Hari Ini* : ${hariini}
⌗ ࣪ ▸ ࣪ *Wib* : ${barat} WIB
⌗ ࣪ ▸ ࣪ *Wita* : ${tengah} WITA
⌗ ࣪ ▸ ࣪ *Wit* : ${timur} WIT
`
...
⌗ ࣪ ▸ ${prefix}linkgroup
⌗ ࣪ ▸ ${prefix}ephemeral [option]
⌗ ࣪ ▸ ${prefix}setppgc [image]
⌗ ࣪ ▸ ${prefix}setname [text]
⌗ ࣪ ▸ ${prefix}setdesc [text]
⌗ ࣪ ▸ ${prefix}group [option]
⌗ ࣪ ▸ ${prefix}editinfo [option]
⌗ ࣪ ▸ ${prefix}add @user
⌗ ࣪ ▸ ${prefix}kick @user
⌗ ࣪ ▸ ${prefix}hidetag [text]
⌗ ࣪ ▸ ${prefix}tagall [text]
⌗ ࣪ ▸ ${prefix}antilink [on/off]
⌗ ࣪ ▸ ${prefix}mute [on/off]
⌗ ࣪ ▸ ${prefix}promote @user
⌗ ࣪ ▸ ${prefix}demote @user
⌗ ࣪ ▸ ${prefix}vote [text]
⌗ ࣪ ▸ ${prefix}devote
⌗ ࣪ ▸ ${prefix}upvote
⌗ ࣪ ▸ ${prefix}cekvote
...
⌗ ࣪ ▸ ${prefix}playstore
⌗ ࣪ ▸ ${prefix}gsmarena
⌗ ࣪ ▸ ${prefix}jadwalbioskop
⌗ ࣪ ▸ ${prefix}nowplayingbioskop
⌗ ࣪ ▸ ${prefix}aminio
⌗ ࣪ ▸ ${prefix}wattpad
⌗ ࣪ ▸ ${prefix}webtoons
⌗ ࣪ ▸ ${prefix}drakor
...
⌗ ࣪ ▸ ${prefix}tiktoknowm [url]
⌗ ࣪ ▸ ${prefix}tiktokwm [url]
⌗ ࣪ ▸ ${prefix}tiktokmp3 [url]
⌗ ࣪ ▸ ${prefix}instagram [url]
⌗ ࣪ ▸ ${prefix}twitter [url]
⌗ ࣪ ▸ ${prefix}twittermp3 [url]
⌗ ࣪ ▸ ${prefix}facebook [url]
⌗ ࣪ ▸ ${prefix}pinterestdl [url]
⌗ ࣪ ▸ ${prefix}ytmp3 [url]
⌗ ࣪ ▸ ${prefix}ytmp4 [url]
⌗ ࣪ ▸ ${prefix}getmusic [query]
⌗ ࣪ ▸ ${prefix}getvideo [query]
⌗ ࣪ ▸ ${prefix}umma [url]
⌗ ࣪ ▸ ${prefix}joox [query]
⌗ ࣪ ▸ ${prefix}soundcloud [url]
...
⌗ ࣪ ▸ ${prefix}play [query]
⌗ ࣪ ▸ ${prefix}yts [query]
⌗ ࣪ ▸ ${prefix}google [query]
⌗ ࣪ ▸ ${prefix}gimage [query]
⌗ ࣪ ▸ ${prefix}pinterest [query]
⌗ ࣪ ▸ ${prefix}wallpaper [query]
⌗ ࣪ ▸ ${prefix}wikimedia [query]
⌗ ࣪ ▸ ${prefix}ytsearch [query]
⌗ ࣪ ▸ ${prefix}ringtone [query]
⌗ ࣪ ▸ ${prefix}stalk [option] [query]
...
⌗ ࣪ ▸ ${prefix}3dchristmas
⌗ ࣪ ▸ ${prefix}3ddeepsea
⌗ ࣪ ▸ ${prefix}americanflag
⌗ ࣪ ▸ ${prefix}3dscifi
⌗ ࣪ ▸ ${prefix}3drainbow
⌗ ࣪ ▸ ${prefix}3dwaterpipe
⌗ ࣪ ▸ ${prefix}halloweenskeleton
⌗ ࣪ ▸ ${prefix}sketch
⌗ ࣪ ▸ ${prefix}bluecircuit
⌗ ࣪ ▸ ${prefix}space
⌗ ࣪ ▸ ${prefix}metallic
⌗ ࣪ ▸ ${prefix}fiction
⌗ ࣪ ▸ ${prefix}greenhorror
⌗ ࣪ ▸ ${prefix}transformer
⌗ ࣪ ▸ ${prefix}berry
⌗ ࣪ ▸ ${prefix}thunder
⌗ ࣪ ▸ ${prefix}magma
⌗ ࣪ ▸ ${prefix}3dcrackedstone
⌗ ࣪ ▸ ${prefix}3dneonlight
⌗ ࣪ ▸ ${prefix}impressiveglitch
⌗ ࣪ ▸ ${prefix}naturalleaves
⌗ ࣪ ▸ ${prefix}fireworksparkle
⌗ ࣪ ▸ ${prefix}matrix
⌗ ࣪ ▸ ${prefix}dropwater
⌗ ࣪ ▸ ${prefix}harrypotter
⌗ ࣪ ▸ ${prefix}foggywindow
⌗ ࣪ ▸ ${prefix}neondevils
⌗ ࣪ ▸ ${prefix}christmasholiday
⌗ ࣪ ▸ ${prefix}3dgradient
⌗ ࣪ ▸ ${prefix}blackpink
⌗ ࣪ ▸ ${prefix}gluetext
...
⌗ ࣪ ▸ ${prefix}beach
⌗ ࣪ ▸ ${prefix}blackpink
⌗ ࣪ ▸ ${prefix}igcertificate
⌗ ࣪ ▸ ${prefix}ytcertificate
...
⌗ ࣪ ▸ ${prefix}tictactoe
⌗ ࣪ ▸ ${prefix}family100
⌗ ࣪ ▸ ${prefix}tebak [option]
⌗ ࣪ ▸ ${prefix}math [mode]
⌗ ࣪ ▸ ${prefix}suitpvp [@tag]
...
⌗ ࣪ ▸ ${prefix}artinama
⌗ ࣪ ▸ ${prefix}ramaljodoh
⌗ ࣪ ▸ ${prefix}ramaljodohbali
⌗ ࣪ ▸ ${prefix}suamiistri
⌗ ࣪ ▸ ${prefix}ramalcinta
⌗ ࣪ ▸ ${prefix}cocoknama
⌗ ࣪ ▸ ${prefix}pasangan
⌗ ࣪ ▸ ${prefix}jadiannikah
⌗ ࣪ ▸ ${prefix}sifatusaha
⌗ ࣪ ▸ ${prefix}rezeki
⌗ ࣪ ▸ ${prefix}pekerjaan
⌗ ࣪ ▸ ${prefix}nasib
...
⌗ ࣪ ▸ ${prefix}nagahari
⌗ ࣪ ▸ ${prefix}arahrezeki
⌗ ࣪ ▸ ${prefix}peruntungan
⌗ ࣪ ▸ ${prefix}weton
⌗ ࣪ ▸ ${prefix}karakter
⌗ ࣪ ▸ ${prefix}keberuntungan
⌗ ࣪ ▸ ${prefix}memancing
⌗ ࣪ ▸ ${prefix}masasubur
⌗ ࣪ ▸ ${prefix}zodiak
...
⌗ ࣪ ▸ ${prefix}owner
⌗ ࣪ ▸ ${prefix}report
⌗ ࣪ ▸ ${prefix}menu / ${prefix}help / ${prefix}?
⌗ ࣪ ▸ ${prefix}delete
⌗ ࣪ ▸ ${prefix}infochat
⌗ ࣪ ▸ ${prefix}quoted
⌗ ࣪ ▸ ${prefix}listpc
...
⌗ ࣪ ▸ ${prefix}react [emoji]
⌗ ࣪ ▸ ${prefix}chat [option]
⌗ ࣪ ▸ ${prefix}join [link]
⌗ ࣪ ▸ ${prefix}leave
⌗ ࣪ ▸ ${prefix}block @user
⌗ ࣪ ▸ ${prefix}unblock @user
⌗ ࣪ ▸ ${prefix}bcgroup [text]
⌗ ࣪ ▸ ${prefix}bcall [text]
⌗ ࣪ ▸ ${prefix}setppbot [image]
⌗ ࣪ ▸ ${prefix}setexif
⌗ ࣪ ▸ ${prefix}setmenu [option]
